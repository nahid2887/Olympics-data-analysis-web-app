...
def participating_nation_over_year(df,col):
...
def Athletes_over_year(df):
    ...
    athletes_over_time.rename(columns={'Year': 'Edition','count':'Name'}, inplace=True)
...
def most_successful(df, sport):
    ...
    x.columns = ['Name', 'Medals']  # Rename the columns explicitly
    x = x.head(15)
